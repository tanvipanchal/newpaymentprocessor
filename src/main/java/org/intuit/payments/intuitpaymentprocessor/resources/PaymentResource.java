...
//	@POST
//	public String asyncPostPaymentsWithTimeout(final IntuitCard intuitCard, @Suspended final AsyncResponse asyncResponse) 
//	{
//		
//		asyncResponse.setTimeoutHandler(new TimeoutHandler() {
//
//			@Override
//			public void handleTimeout(final AsyncResponse asyncResponse2) {
//				
//				asyncResponse2.setTimeout(5, TimeUnit.SECONDS);	
//				
...
//						String result;
//						
//						ChargeResponse charge = stripeEndpoint.retriveCharge("");
//						
//						
...
//						.entity("Operation time out, payment is NOT successful, please try again").build());
//				
//			}
//			
//			
