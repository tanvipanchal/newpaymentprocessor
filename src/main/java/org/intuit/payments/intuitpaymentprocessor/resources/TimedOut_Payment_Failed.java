...
import org.intuit.payments.intuitpaymentprocessor.model.FailedChargeMock;
...
@Path("/v1/TimedOut_Payment_Failed")
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public class TimedOut_Payment_Failed {
	
	
	@POST
	public Message postPayment(@Suspended final AsyncResponse asyncResponse)
	{
		final FailedChargeMock c = new FailedChargeMock();
